...
<html lang="en">
  ...
  <title>Birthday and Beyond</title>
   <meta charset="utf-8">
    ...
    <nav class="navbar navbar-expand-sm navbar-light sticky-top" style="background-color: #f6c0e0">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto justify-content-end ">
          ...
          <a class="btn btn-light btn-lg dropdown-toggle" href="cards.html" style = "background-color: #ff66d9;" role="button" id="dropdownMenuLink"  data-toggle="dropdown" aria-haspopup="true">
            Cards
          </a>
		...
		<div class="row justify-content-center">
			...
			<div class="col-md-10">
						...
						<div class="row no-gutters">
							...
							<div class="col-sm-2">
								...
								<div class="small-box">
									...
									Gaint (A3) <br><strong>$9.99</strong>
							...
							<div class="col-sm-2">
								...
								<div class="small-box">
									...
									Large (A4) <br><strong>$5.99</strong>
							...
							<div class="col-sm-2">
								...
								<div class="small-box">
									...
									Standard (A5) <br><strong>$9.99</strong>
							...
							<div class="col-sm-2">
								...
								<div class="small-box">
									...
									Small (A6) <br><strong>$9.99</strong>
							...
							<div class="col-sm-4">
								...
								<div class="small-box border-0">
									...
									<label class="checkbox-container">Luxury Choclate Card
									...
									<label class="checkbox-container">Large Card
					...
					<div class="inner-boxes">
						...
						<div class="row">
							...
							<div class="col-sm-5">
								...
								<div class="inside-box left-card">

									<h6>Card Preview</h6>

								</div><!-- /inside-box -->

								<div class="top-boxes all-border">
									...
									<div class="row no-gutters">
										...
										<div class="col-sm-3">
											...
											<div class="small-box">
												...
												<i class="fas fa-box"></i> <br> Inside Left
										...
										<div class="col-sm-3">
											...
											<div class="small-box">
												...
												<i class="fas fa-box"></i> <br> Inside Right
							...
							<div class="col-sm-7">
								...
								<div class="inside-box ">
									...
									<div class="row no-gutters">
										...
										<div class="col-md-8">
											...
											<div class="float-left">
												...
												<input type="range" class="custom-range w-0">
									...
									<div class="mt-4 text-center">
										...
										<h6 class="small mb-3">Preview your card before Purchasing</h6>

										<button class="btn btn-purchase">Preview your card</button>
				...
				<div class="text-right mt-3">
					...
					<label class="checkbox-container"><strong>Quality:</strong>
					...
					<button class="btn btn-purchase bo">Add to Cart</button>

					<button class="btn btn-purchase">Continue</button>
